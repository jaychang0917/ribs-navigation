...
class AddCreditCardBuilder(dependency: ParentComponent) : ViewBuilder<AddCreditCardView, AddCreditCardRouter, AddCreditCardBuilder.ParentComponent>(dependency) {
  ...
  abstract class Module {
    ...
    companion object {
      ...
      fun router(
          ...
          interactor: AddCreditCardInteractor): AddCreditCardRouter {
